...
public class Zombie2 extends Enemigo {

    private static HojaSprites hojaZombie;

    public Zombie2(int idEnemigo, String nombre, int vidaMaxima, int ataqueMinimo, int ataqueMaximo, int defensaMaxima, int nivel,
