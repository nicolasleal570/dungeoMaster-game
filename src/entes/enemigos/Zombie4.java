...
public class Zombie4 extends Enemigo {

    private static HojaSprites hojaZombie;

    public Zombie4(int idEnemigo, String nombre, int vidaMaxima, int ataqueMinimo, int ataqueMaximo, int defensaMaxima, int nivel,
