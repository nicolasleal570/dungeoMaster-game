...
public class Escopeta extends Arma {
    ...
    public Escopeta(int id, String nombre, String descripcion, int ataqueMinimo, int ataqueMaximo, boolean automatica, boolean penetrante, double ataquePorSegundo) {
