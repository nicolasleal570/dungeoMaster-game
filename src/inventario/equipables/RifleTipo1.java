...
public class RifleTipo1 extends Arma {

    public RifleTipo1(int id, String nombre, String descripcion, int ataqueMinimo, int ataqueMaximo, boolean automatica, boolean penetrante, double ataquePorSegundo) {
