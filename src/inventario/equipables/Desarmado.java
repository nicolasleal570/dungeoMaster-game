...
public class Desarmado extends Arma {
    ...
    public Desarmado(int id, String nombre, String descripcion, int ataqueMinimo, int ataqueMaximo, boolean automatica, boolean penetrante, double ataquePorSegundo) {
    ...
    public ArrayList<Rectangle> getAlcance(final Jugador jugador) {
        ...
        if (jugador.getDireccion() == 0 || jugador.getDireccion() == 1) {
            ...
            alcance1.height = 1 * Constantes.LADO_SPRITE; // Alto del alcance
            ...
            alcance1.width = 1 * Constantes.LADO_SPRITE; // Ancho del alcance
